...
class _FoodScreenState extends State<FoodScreen> {
  List<Dish> dishes = [
    ...
    Dish(name: 'beef rice', price: 300, orderCount: 0),
    Dish(name: 'whole tilapia fish', price: 200, orderCount: 0),
    Dish(name: 'beef stew ', price: 350, orderCount: 0),
    Dish(name: 'chiken', price: 130, orderCount: 0),
    Dish(name: 'Malik Fries', price: 200, orderCount: 0),
    Dish(name: 'Masala fries', price: 230, orderCount: 0),
    Dish(name: 'Beef Fries', price: 250, orderCount: 0),
    Dish(name: 'spaghetti beef stew', price: 130, orderCount: 0),
    Dish(name: 'Drum sticks', price: 240, orderCount: 0),
